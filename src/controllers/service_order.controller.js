...
const send_sms_to_employee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const sid = yield (0, sms_utils_1.sendOrderWithReplyButton)(employeePhone, {
            contact,
            locationName,
            villageName,
            city,
        ...
        const orderData = {
            user_id,
            employees_id: employee.id,
            cat_id: (_a = employee.cat_id) !== null && _a !== void 0 ? _a : null,
            address_users_detail_id: parsedAddressId,
            amount: (_b = employee.price) !== null && _b !== void 0 ? _b : 0,
